...
public class ARPPackageFrame extends JFrame implements ActionListener{
	...
	// 界面有关变量
		...
		public ARPPackageFrame(Packages packages){
			...
			JLabel jlb_TTL = new JLabel("硬件类型：");
			...
			jtf_offset.setText(packages.rsv_tos);
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource()==jbt1)
			{
				new DetailARPPackages(packages);
			}
