...
case 0:
	this.dispose();
	int chosen = JOptionPane.showOptionDialog(this, "Macbook Air？", "选择电脑型号", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
	if(chosen==JOptionPane.NO_OPTION)
	{
		JOptionPane.showMessageDialog(this, "此软件暂时只支持Macbook air且为Linux/Unix系统");
		System.exit(0);
	}
	new MainFrame();
