...
public class QueryByOthers extends JPanel {

	JTable table;
	DefaultTableModel tableModel;
	String[] columnNames = { "编号", "姓名", "性别", "部门", "级别", "工资总额", "" };

	public QueryByOthers(String result) {
	...
	public void UpdateRow(int row, String[] items) {
	...
	public static void createAndShowGUI(String result) {
		...
		QueryByOthers newContentPane = new QueryByOthers(result);
	...
	public void updaeALL(String result) {
		String[] item = result.split("#");
		int rows = item.length;
